...
# Load the configuration using parse_yaml
eval $(parse_yaml "$CONFIG_FILE")

# Function to set variables without prefix
set_variables() {
    local prefix=$1
...
for var in DB_PORT DB_URL DB_USERNAME DB_PASSWORD; do
