...
const isHome: boolean = this.$route.path === "/home";
const isLogin: boolean = this.$route.path === "/login";
const isBrowse: boolean = this.$route.path === "/browse";
const isDoc: boolean = this.$route.path.startsWith("/doc");
